...
class LobbyContainer extends Component {
    ...
    render() {
        ...
        const messages = [
            {index: 1, name: "Person", message: "blen"},
            {index: 2, name: "dude", message: "bleadsfasdfn"},
            {index: 3, name: "woman", message: "badfasdffasdfalen"},
            {index: 4, name: "man", message: "bleadfadsfsadfasdfadfan"},
        ];
...
class LobbySidebar extends Component {
    constructor(props) {
        ...
        this._login = () => {
            console.log("TODO: Implment login");
        };
        ...
        return (
            <section className="c-lobby-sidebar">
                <div className="m-sidebar-buttons">
                    {!canLogin ? null :
                        <button className="m-button primary"
                                onClick={this._login}>
                            Login
                        </button>}

                    {!canCreateGame ? null :
                        <button onClick={this._createGame}
