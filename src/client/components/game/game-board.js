    ...
    render() {
        ...
        switch (game.step) {
            case A.STEP_CHOOSE_WHITES:
                ...
                message = opSelectCard.can ? "choose your card!" : 'waiting for other players...';
                break;
            ...
            case A.STEP_WAIT:
                message = `${TIMER_REASONS[game.timer.type]}, ${TIMER_REASONS[game.timer.reason]}`;
                break;
        }
        ...
        return (
            <section className="c-game-board">
                ...
                <PlayerHand opSelectCard={opSelectCard}
