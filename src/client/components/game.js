...
class GameContainer extends ContainerBase {
    constructor(props) {
        ...
        this._sendMessage = message => this.request(A.gameSendMessage(this.state.game.id, message));
    }
    ...
    render() {
        ...
        return (
            <section className="c-game-sidebar">
                <div className="m-sidebar-button">
                    {!opLogin.can ? null :
                        <button className="m-button primary" onClick={this._login}>Login to join game.</button>}
